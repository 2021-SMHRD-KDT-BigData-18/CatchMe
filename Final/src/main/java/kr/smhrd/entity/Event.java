...
public class Event {
	...
	public Event(int event_seq, int rec_seq, String event_content, Date event_at, String event_img, String base64Image,
			int sun, int mon, int tue, int wed, int thu, int fri, int sat, int sun_sleep, int sun_nolook, int mon_sleep,
			int mon_nolook, int tue_sleep, int tue_nolook, int wed_sleep, int wed_nolook, int thu_sleep, int thu_nolook,
			int fri_sleep, int fri_nolook, int sat_sleep, int sat_nolook) {
		super();
